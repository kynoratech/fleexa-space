      ...
      <header className="relative pt-20 pb-24 overflow-hidden text-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="/register" className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900 text-white font-bold shadow-xl shadow-slate-200 hover:bg-slate-800 transition-all flex items-center justify-center gap-2 group">
             <ArrowRight className="h-4 w-4 group-hover:translate-x-1 transition-transform" />Comenzar gratis
            </a>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-left">
            <motion.div whileHover={{ scale: 1.01 }} className="bg-white p-10 rounded-3xl border border-emerald-200 shadow-xl shadow-emerald-100/20 relative">
              ...
              <a href="/register" className="w-full py-4 rounded-xl bg-slate-900 text-white font-bold hover:bg-slate-800 transition-all">Crear cuenta gratis</a>
            </motion.div>
            ...
            <motion.div whileHover={{ scale: 1.01 }} className="bg-white p-10 rounded-3xl border border-indigo-200 shadow-xl shadow-indigo-100/20 relative">
              ...
              <a href="/checkout" className="w-full py-4 rounded-xl bg-indigo-600 text-white font-bold hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200">Pagar con Webpay</a>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex items-center gap-3">
            <div className="h-7 w-7 rounded-lg bg-slate-900 flex items-center justify-center shadow-md">
              <img src="/favicon.ico" className="h-4 w-4" alt="Fleexa Space Logo" />
            </div>
