  ...
  useEffect(() => {
    const load = async () => {
      ...
      const [clientsSnap, projectsSnap, tasksSnap] = await Promise.all([
        getCountFromServer(collection(db, "workspaces", workspace.workspaceId, "clients")),
        getCountFromServer(collection(db, "workspaces", workspace.workspaceId, "projects")),
        getCountFromServer(collection(db, "workspaces", workspace.workspaceId, "tasks")),
      ]);
