...
import { ArrowLeft, Loader2, Mail, Lock, ChevronRight } from "lucide-react";
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen grid lg:grid-cols-2 bg-white font-sans selection:bg-indigo-100">
      ...
      {/* SECCIÓN IZQUIERDA: INSPIRADA EN TU REFERENCIA OSCURA */}
      ...
      {/* SECCIÓN DERECHA: FORMULARIO LIMPIO */}
          ...
          >
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/40 p-8">
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <div>
                  ...
                  <div className="relative mt-2">
                    ...
                    <input
                      type="email"
                      className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-50 border border-slate-200 text-sm focus:bg-white focus:border-indigo-600 focus:ring-4 focus:ring-indigo-600/5 transition-all outline-none"
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-indigo-600 text-white font-bold text-sm shadow-lg shadow-indigo-200 hover:bg-indigo-700 transition-all active:scale-[0.98] flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
              ...
              <button
                ...
                disabled={loadingEmail || loadingGoogle}
                className="w-full py-3 rounded-xl border border-slate-200 bg-white text-slate-700 font-bold text-sm hover:bg-slate-50 hover:border-slate-300 transition-all flex items-center justify-center gap-3 disabled:opacity-70"
              >
